      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 reveal-group">
          ...
          <TiltCard className="h-full">
            <div className="glass-card bg-[#F5F5F7]/85 p-8 rounded-3xl flex flex-col justify-between border border-black/5 hover:bg-white hover:shadow-2xl transition-all duration-300 stagger-item h-full">
          ...
          <TiltCard className="h-full">
            <div className="glass-card bg-[#F5F5F7]/85 p-8 rounded-3xl flex flex-col justify-between border-2 border-black relative hover:bg-white hover:shadow-2xl transition-all duration-300 stagger-item shadow-double-layer h-full">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-black text-white font-semibold text-[10px] uppercase py-1 px-4 rounded-full tracking-wider z-20">
                {t("price.mostPopular")}
              </div>
              <div className="space-y-6">
                <div>
