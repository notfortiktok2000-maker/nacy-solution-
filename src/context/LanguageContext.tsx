...
const dictionary: Record<LanguageType, Record<string, string>> = {
  EN: {
    ...
    "nav.serviceWeb": "Lead Generation",
    "nav.servicePhoto": "Lead Gen + Landing Page",
    "nav.serviceVideo": "Lead Gen + Landing Page + Content",
    ...
    // Marquee
    "marquee.website": "Lead Generation",
    "marquee.photo": "Lead Gen + Landing Page",
    "marquee.video": "Lead Gen + Landing Page + Content",
    ...
    "services.webDesc": "Automated B2B lead generation infrastructure. We scrape high-intent data, enrich it, and craft tailored cold outreach campaigns to book meetings directly on your calendar.",
    "services.webF1": "Data scraping & enrichment from ZoomInfo/Apollo",
    "services.webF2": "Multi-channel sequences (Email + LinkedIn)",
    "services.webF3": "Advanced deliverability & inbox warming",
    "services.webF4": "Direct calendar bookings & CRM routing",
    "services.photoDesc": "Combine our automated lead generation infrastructure with a highly optimized, conversion-focused landing page designed to turn prospects into booked meetings.",
    "services.photoF1": "Setup of 5 secondary sending domains",
    "services.photoF2": "Automated IP and domain warming",
    "services.photoF3": "Spam-trap avoidance & DMARC/SPF/DKIM",
    "services.photoF4": "A/B testing of copy and subject lines",
    "services.videoDesc": "The ultimate outbound engine. We provide lead generation, a custom landing page, and complete content creation including optimized sales scripts and messaging.",
    "services.videoF1": "Automated connection requests at scale",
    "services.videoF2": "Personalized DM follow-up sequences",
    "services.videoF3": "Email extraction from target profiles",
  ...
  FR: {
    ...
    "nav.serviceWeb": "Génération de Leads",
    "nav.servicePhoto": "Lead Gen + Landing Page",
    "nav.serviceVideo": "Lead Gen + Landing Page + Contenu",
    ...
    // Marquee
    "marquee.website": "Génération de Leads B2B",
    "marquee.photo": "Automatisation d'Emails Outbound",
    "marquee.video": "Prospection LinkedIn",
    ...
    "services.s02": "SERVICE 02",
    "services.s03": "SERVICE 03",
    "services.webDesc": "Infrastructure de génération de leads B2B automatisée. Nous scrapons les données, les enrichissons et créons des campagnes sur mesure pour générer des rendez-vous.",
    "services.webF1": "Scraping & enrichissement via ZoomInfo/Apollo",
    "services.webF2": "Séquences multicanales (E-mail + LinkedIn)",
    "services.webF3": "Délivrabilité avancée & chauffe d'inbox",
    "services.webF4": "Réservation directe & synchronisation CRM",
    "services.photoDesc": "Associez notre infrastructure de génération de leads automatisée à une page de destination hautement optimisée et axée sur la conversion pour maximiser vos prises de rendez-vous.",
    "services.photoF1": "Configuration de 5 domaines d'envoi secondaires",
    "services.photoF2": "Chauffe automatisée des IP et domaines",
    "services.photoF3": "Évitement des spam-traps & DMARC/SPF/DKIM",
    "services.photoF4": "Tests A/B des objets et contenus",
    "services.videoDesc": "Le moteur de vente ultime. Nous fournissons la génération de leads, une page de destination sur mesure, ainsi que la création complète de contenu incluant scripts et argumentaires.",
    "services.videoF1": "Demandes de connexion automatisées ciblées",
    "services.videoF2": "Séquences de messages de suivi (DM) personnalisées",
    "services.videoF3": "Extraction d'e-mails à partir des profils B2B",
